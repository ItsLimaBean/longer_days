...
namespace CAM
{
	...
	static Vector3 _GET_GAMEPLAY_CAM_COORDS() { return invoke<Vector3>(0x5352E025EC2B416F); } // 0x5352E025EC2B416F b1207
	static Vector3 _GET_GAMEPLAY_CAM_ROT(int rotationOrder) { return invoke<Vector3>(0x602685BD85DD26CA, rotationOrder); } // 0x602685BD85DD26CA b1207
...
namespace DATAFILE
{
	...
	static Vector3 _OBJECT_VALUE_GET_Vector3(Any* objectData, const char* key) { return invoke<Vector3>(0xE459C941431E0FFA, objectData, key); } // 0xE459C941431E0FFA b1207
...
namespace ENTITY
{
	...
	static Vector3 GET_ENTITY_COORDS(Any p0, Any p1, Any p2) { return invoke<Vector3>(0xA86D5F069399F44D, p0, p1, p2); } // 0xA86D5F069399F44D b1207
...
namespace PED
{
	...
	static Vector3 GET_ANIM_INITIAL_OFFSET_POSITION(const char* animDict, const char* animName, float x, float y, float z, float xRot, float yRot, float zRot, float p8, int p9) { return invoke<Vector3>(0xBE22B26DD764C040, animDict, animName, x, y, z, xRot, yRot, zRot, p8, p9); } // 0xBE22B26DD764C040 b1207
	static Vector3 GET_ANIM_INITIAL_OFFSET_ROTATION(const char* animDict, const char* animName, float x, float y, float z, float xRot, float yRot, float zRot, float p8, int p9) { return invoke<Vector3>(0x4B805E6046EE9E47, animDict, animName, x, y, z, xRot, yRot, zRot, p8, p9); } // 0x4B805E6046EE9E47 b1207
...
namespace TASK
{
	...
	static BOOL WAYPOINT_RECORDING_GET_COORD(const char* name, int point, Vector3* coord) { return invoke<BOOL>(0x2FB897405C90B361, name, point, coord); } // 0x2FB897405C90B361 b1207
...
namespace VEHICLE
{
	...
	static Vector3 GET_POSITION_OF_VEHICLE_RECORDING_AT_TIME(int p0, float p1, const char* p2) { return invoke<Vector3>(0x1A00961A1BE94E5E, p0, p1, p2); } // 0x1A00961A1BE94E5E b1207
